# doc_intv_adult.py
"""
Python equivalent of Doc_Intv_Adult.bas
Implements Intv_Adult_Output logic as a function (stub for now, expand as needed).
"""
...
def intv_adult_output(lookup_id=None, output_path=None, intv_data=None):
    with open(
        os.path.join(os.path.dirname(__file__), "..", "..", "config", "intv_adult_vars.json"), "r", encoding="utf-8"
    ) as f:
    ...
    def get_personal_reference(resolved, default="the adult"):
        ...
        if first and last:
            ...
            return f"Mr./Ms. {last}"
        return default
    person_ref = get_personal_reference(resolved, default="the adult")
    Tmp = ""
    ...
    for config in section_configs:
        ...
        # Interpolate placeholders in the default text
